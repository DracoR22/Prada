...
const VideoComponent = ({ element }: Props) => {
    ...
    return (
        <div style={styles} draggable onDragStart={(e) => handleDragStart(e, 'video')} onClick={handleOnClick}
        className={clsx('p-[2px] w-full m-[5px] relative text-[16px] transition-all flex items-center justify-center', {
              ...
              {state.editor.selectedElement.id === element.id && !state.editor.liveMode && (
               ...
               {!Array.isArray(element.content) && (
                <iframe width={element.styles.width || '560'} height={element.styles.height || '315'} src={element.content.src}
