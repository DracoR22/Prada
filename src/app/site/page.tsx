...
const Home = async () => {
  ...
  return (
    <>
      <section className="h-full w-full md:mt-44 mt-[-70px] relative flex items-center justify-center flex-col ">
        {/* GRID */}
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-[120px] mt-[-60px]">
